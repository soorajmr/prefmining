"""
Taken from http://deeplearning.net/tutorial/code/ with only minor changes.
"""
import os
import sys
import timeit
...
""" 
Restricted Boltzmann Machine (RBM) using Theano.
"""
class RBM(object):
...
'''
Deep Belief Network using the RMB class
'''
class DBN(object):
    """Deep Belief Network
